...
public interface RCDeviceListener {
    // map RCConnectivityStatus enum with Reachability.h:NerworkStatus enum 1-1
     enum RCConnectivityStatus {
        ...
        // no restcomm connectivity either we have no internet connectivity or couldn't register to restcomm (or both)
    }
    /**
    ...
    public abstract void onRegisterState( boolean connectivityStatus);
}
